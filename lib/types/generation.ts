...
export interface StylePreferences {
  ...
  language: string; // 'zh-CN', 'en-US', 'ko-KR'
}
...
export interface UserRequirements {
  ...
  language: 'en-US' | 'ko-KR'; // Course language - critical for generation
...
export interface SceneOutline {
  ...
  order: number;
  language?: 'en-US' | 'ko-KR'; // Generation language (inherited from requirements)
